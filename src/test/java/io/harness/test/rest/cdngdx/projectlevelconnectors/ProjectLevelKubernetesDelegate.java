...
public class ProjectLevelKubernetesDelegate extends AbstractTest {

    K8sVariationHelper k8sVariationHelper = new K8sVariationHelper();
    ConnectorsHelper connectorsHelper = new ConnectorsHelper();

    @Test
    public void testCreateK8SDelegateProjectConnector() throws IOException {
    ...
    @Test
    public void testUpdateK8SDelegateProjectConnector() throws IOException {
        String connectorType = "K8sCluster";
        String k8sType = "InheritFromDelegate";
        String delegateName = "delegateName";
    ...
    @Test
    public void testGetK8SDelegateProjectConnector() throws IOException {
        String connectorType = "K8sCluster";
        String k8sType = "InheritFromDelegate";
        String delegateName = "delegateName";
    ...
    @Test
    public void testDeleteK8SDelegateProjectConnector() throws IOException {
        String connectorType = "K8sCluster";
        String k8sType = "InheritFromDelegate";
        String delegateName = "delegateName";
        String accountIdentifier="zEaak-FLS425IEO7OLzMUg";
    ...
    @Test
    public void testListK8SDelegateProjectConnector() throws IOException {
        String connectorType = "K8sCluster";
        String k8sType = "InheritFromDelegate";
        String delegateName = "delegateName";
        String accountIdentifier="zEaak-FLS425IEO7OLzMUg";

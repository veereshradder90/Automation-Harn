...
public class OrgLevelKubernetesOidc extends AbstractTest {

    K8sVariationHelper k8sVariationHelper = new K8sVariationHelper();
    ConnectorsHelper connectorsHelper = new ConnectorsHelper();

    @Test
    public void testCreateK8SODICOrgLevelConnector() throws IOException {
    ...
    @Test
    public void testEditK8SODICOrgLevelConnector() throws IOException {
        String configType = "ManualConfig";
        String connectorType = "K8sCluster";
        String masterUrl = "https://34.67.13.218";
    ...
    @Test
    public void testGetK8SODICOrgLevelConnector() throws IOException {
        String configType = "ManualConfig";
        String connectorType = "K8sCluster";
        String masterUrl = "https://34.67.13.218";
    ...
    @Test
    public void testDeleteK8SODICOrgLevelConnector() throws IOException {
        String configType = "ManualConfig";
        String connectorType = "K8sCluster";
        String masterUrl = "https://34.67.13.218";
    ...
    @Test
    public void testListK8SODICOrgLevelConnector() throws IOException {
        String configType = "ManualConfig";
        String connectorType = "K8sCluster";
        String masterUrl = "https://34.67.13.218";

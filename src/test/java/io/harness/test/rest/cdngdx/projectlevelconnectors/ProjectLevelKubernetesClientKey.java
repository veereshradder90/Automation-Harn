...
public class ProjectLevelKubernetesClientKey extends AbstractTest {

    K8sVariationHelper k8sVariationHelper = new K8sVariationHelper();
    ConnectorsHelper connectorsHelper = new ConnectorsHelper();

    @Test
    public void testCreateK8SClientKeyProjectConnector() throws IOException {
    ...
    @Test
    public void testUpdateK8SClientKeyProjectConnector() throws IOException {
        String configType = "ManualConfig";
        String connectorType = "K8sCluster";
        String masterUrl = "https://34.67.13.218";
    ...
    @Test
    public void testGetK8SClientKeyProjectConnector() throws IOException {
        String configType = "ManualConfig";
        String connectorType = "K8sCluster";
        String masterUrl = "https://34.67.13.218";
    ...
    @Test
    public void testDeleteK8SClientKeyProjectConnector() throws IOException {
        String configType = "ManualConfig";
        String connectorType = "K8sCluster";
        String masterUrl = "https://34.67.13.218";
        String accountIdentifier="zEaak-FLS425IEO7OLzMUg";
    ...
    @Test
    public void testListK8SClientKeyProjectConnector() throws IOException {
        String configType = "ManualConfig";
        String connectorType = "K8sCluster";
        String masterUrl = "https://34.67.13.218";

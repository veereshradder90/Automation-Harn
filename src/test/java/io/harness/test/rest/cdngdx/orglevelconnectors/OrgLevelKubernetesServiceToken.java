...
public class OrgLevelKubernetesServiceToken extends AbstractTest {

    K8sVariationHelper k8sVariationHelper = new K8sVariationHelper();
    ConnectorsHelper connectorsHelper = new ConnectorsHelper();

    @Test
    public void testCreateK8SManualServiceTokenOrgLevelConnector() throws IOException {
    ...
    @Test
    public void testEditK8SManualServiceTokenOrgLevelConnector() throws IOException {
        String configType = "ManualConfig";
        String connectorType = "K8sCluster";
        String masterUrl = "https://34.67.13.218";
        String specAuthType = "ServiceAccount";
    ...
    @Test
    public void testGetK8SManualServiceTokenOrgLevelConnector() throws IOException {
        String configType = "ManualConfig";
        String connectorType = "K8sCluster";
        String masterUrl = "https://34.67.13.218";
        String specAuthType = "ServiceAccount";
    ...
    @Test
    public void testDeleteK8SManualServiceTokenOrgLevelConnector() throws IOException {
        String configType = "ManualConfig";
        String connectorType = "K8sCluster";
        String masterUrl = "https://34.67.13.218";
        String specAuthType = "ServiceAccount";
    ...
    @Test
    public void testListK8SManualServiceTokenOrgLevelConnector() throws IOException {
        String configType = "ManualConfig";
        String connectorType = "K8sCluster";
        String masterUrl = "https://34.67.13.218";
        String specAuthType = "ServiceAccount";

...
public class OrgLevelKubernetesDelegate extends AbstractTest {

    K8sVariationHelper k8sVariationHelper = new K8sVariationHelper();
    ConnectorsHelper connectorsHelper = new ConnectorsHelper();

    @Test
    public void testCreateK8SDelegateOrgLevelConnector() throws IOException {
    ...
    @Test
    public void testEditK8SDelegateOrgLevelConnector() throws IOException {
        String connectorType = "K8sCluster";
        String k8sType = "InheritFromDelegate";
        String delegateName = "delegateName";
    ...
    @Test
    public void testGetK8SDelegateOrgLevelConnector() throws IOException {
        String connectorType = "K8sCluster";
        String k8sType = "InheritFromDelegate";
        String delegateName = "delegateName";
    ...
    @Test
    public void testDeleteK8SDelegateOrgLevelConnector() throws IOException {
        String connectorType = "K8sCluster";
        String k8sType = "InheritFromDelegate";
        String delegateName = "delegateName";
        String accountIdentifier="zEaak-FLS425IEO7OLzMUg";
    ...
    @Test
    public void testListK8SDelegateOrgLevelConnector() throws IOException {
        String connectorType = "K8sCluster";
        String k8sType = "InheritFromDelegate";
        String delegateName = "delegateName";
        String accountIdentifier="zEaak-FLS425IEO7OLzMUg";

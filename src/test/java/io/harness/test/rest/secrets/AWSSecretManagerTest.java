...
@Slf4j
@Test(groups = {"PL", "Secrets", "PR", "QA", "PROD"}, enabled = false)
public class AWSSecretManagerTest extends AbstractTest {
  ...
  @BeforeClass
  public void setupSM() {
    awssm = commonHelper.createRandomName("awssm");
    Response response = secretManagerHelper.createAzureVaultSecretManager(awssm);
  ...
  public void testAdditionOfReferenceSecretToVault() {
    ...
    String secretValue = "harness/SecretInAWS_SM";
  ...
  public void clearSecrets() {
    ...
    secretManagerHelper.deleteSecretManagerByName(awssm, SecretManagerType.AZURE_VAULT);
  }
}

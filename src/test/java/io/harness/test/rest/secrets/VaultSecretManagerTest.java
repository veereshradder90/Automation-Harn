...
public class VaultSecretManagerTest extends AbstractTest {
  ...
  String hashicorp_vault = null;

  @BeforeClass
  public void setupVaultSM() {
    hashicorp_vault = commonHelper.createRandomName("hashicorp_vault");
  ...
  public void testAdditionOfReferenceSecretToVault() {
    ...
    String secretValue = "/guna/SECRET_TEXT/newtest#value";
  ...
  public void clearSecrets() {
    ...
    secretManagerHelper.deleteSecretManagerByName(hashicorp_vault, SecretManagerType.HASHICORP_VAULT);
  }
}

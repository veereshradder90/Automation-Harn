...
public class AWSKMSSecretManagerTest extends AbstractTest {
  ...
  @BeforeClass
  public void setupSM() {
    awsKms = commonHelper.createRandomName("awsKms");
  ...
  public void clearSecrets() {
    ...
    secretManagerHelper.deleteSecretManagerByName(awsKms, SecretManagerType.AWS_KMS);
  }
}

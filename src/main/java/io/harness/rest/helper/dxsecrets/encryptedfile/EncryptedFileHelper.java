package io.harness.rest.helper.dxsecrets.encryptedfile;
...
import io.harness.rest.helper.dxsecrets.encryptedtext.EncryptedTextConstants;
...
public class EncryptedFileHelper extends CoreUtils {
    ...
    public JsonPath getEncryptedFileSecretsByIdSanity(String etId) throws IOException {
        File file = new File(System.getProperty("user.dir") + EncryptedFileTypeConstants.ENCRYPTED_FILE_GET_BY_ID);
    ...
    public JsonPath getEncryptedFileSecretsByNameSanity(String etName) throws IOException {
        File file = new File(System.getProperty("user.dir") + EncryptedFileTypeConstants.ENCRYPTED_FILE_GET_BY_NAME);
        JsonObject appReqData = new JsonObject();

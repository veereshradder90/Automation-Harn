package io.harness.rest.helper.dxsecrets.winRM;
...
public class WinrmHelper extends CoreUtils {
    ...
    public JsonPath getWinrmSecretsByIdSanity(String etId) throws IOException {
        File file = new File(System.getProperty("user.dir") + WinrmConstants.WINRM_GET_BY_ID);
    ...
    public JsonPath getWinrmSecretsByNameSanity(String etName) throws IOException {
        File file = new File(System.getProperty("user.dir") + WinrmConstants.WINRM_GET_BY_NAME);
        JsonObject appReqData = new JsonObject();
